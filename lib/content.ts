...
export const about = {
  paragraphs: [
    ...
    "Outside the shop: Team Leader for CWRU's NHRL combat robotics team, lead pianist and drummer at my church, and hands-on in my family's construction business — which means my engineering instincts get tested against real jobsites, not just tolerances on a drawing.",
  ],
  skillGroups: [
    {
      label: "CAD & DESIGN",
